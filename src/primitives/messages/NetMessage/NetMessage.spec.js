...
describe('NetMessage', () => {
    ...
    it('should allow to parse from hex', () => {
        ...
        expect(message.toHash()).to.equal('cb0c82fc6c5b579da7d65bccf60825d85deea29aaa95dae418606664148f8f5c');
    ...
    it('should create a net message with kind and cluster', () => {
        ...
        expect(parsed.toHash()).to.equal('daeed319bdcb6908b7260b421bf488bffd18126fb5ab8191d442d689c3ef5b58');
        ...
        expect(parsed2.toHash()).to.equal('daeed319bdcb6908b7260b421bf488bffd18126fb5ab8191d442d689c3ef5b58');
