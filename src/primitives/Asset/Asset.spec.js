...
describe('Asset', () => {
    ...
    it('should to have the same hash', () => {
        expect(asset.toHash('hex')).toEqual('8a85d48a9bbd42d7efd885e08e1e7a6ef11cfc220277f337fe80bba9cc429ec7');
        expect(customAsset.toHash('hex')).toEqual('92d375621a881d20e15e972b65b7dabb3aaca7ae09b107454602fa77e43f722d');
    });
    ...
    it('should fromUint8Array to have the same asset', () => {
        ...
        expect(Asset.fromUint8Array(asset.toUint8Array()).toHash('hex')).toEqual(asset.toHash('hex'));
        expect(Asset.fromUint8Array(asset.toUint8Array()).toHash('hex')).toEqual('c0e92d2e0aa4c0a48e0fa373ebbd789cb4a2043c5377e8b439049520fd03cc56');
