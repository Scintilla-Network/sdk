...
describe('ClusterBlock', () => {
    ...
    it('should consider a state action', () => {
        ...
        expect(hashProof.toHash('hex')).toEqual('279cefcc2990abfe25337259033c378c935a24a0c1184b565a8113445a5918e7');

        clusterBlock.consider(hashProof);

        const parsedClusterBlock = ClusterBlock.fromUint8Array(clusterBlock.toUint8Array());
        expect(parsedClusterBlock.toHash('hex')).toEqual('3c2ac726057533b79b70abfec523c7aae0f6f54cd11562833562b1d59c208427');
        expect(parsedClusterBlock.toHex()).toEqual('');
        expect(clusterBlock.toHex()).toEqual('');
